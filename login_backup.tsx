...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // Use axios directly to catch 419 errors before Inertia processes them
            ...
            // If successful, do a full page redirect
            // Let Inertia handle redirect
        , { preserveState: true, preserveScroll: true, onError: (errors: any) => { if (errors.message?.includes("419")) { setCsrfError(true); setErrors({ general: "Session expired. Refresh page." }); } else { setErrors(errors); } }, onSuccess: () => {}, onFinish: () => { setIsSubmitting(false); } });
    };
