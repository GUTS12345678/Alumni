    ...
    public function run(): void
    {
        ...
        $templates = [
            ...
            [
                ...
                'usage_count' => 0,
                'last_sent_at' => now()->subMonths(2),
                'created_by' => $createdBy,
            ],
            [
                'name' => 'Birthday Wishes',
                'subject' => 'Happy Birthday, {{first_name}}! 🎂',
                'body' => '<h2 style="color: #800000;">Happy Birthday, {{first_name}} {{last_name}}! 🎉</h2><p>The entire Alumni Relations team wishes you a wonderful birthday filled with joy and happiness!</p><p>Thank you for being part of our alumni community. We hope this year brings you success in all your endeavors.</p><p>Best wishes,<br>Alumni Relations Team</p>',
            ...
            [
                ...
                'subject' => 'Keep your alumni profile up to date',
                'body' => '<h2>Hi {{first_name}},</h2><p>It\'s been {{days_since_update}} days since you last updated your alumni profile.</p><p>Keeping your profile current helps us:</p><ul><li>Provide relevant career opportunities</li><li>Connect you with fellow alumni</li><li>Understand our community better</li></ul><p><a href="{{profile_link}}" style="background-color: #800000; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block; margin-top: 10px;">Update My Profile</a></p><p>Thank you for staying connected!</p>',
                'category' => 'Account',
                'type' => 'reminder',
                'status' => 'active',
                'variables' => ['first_name', 'days_since_update', 'profile_link'],
                'usage_count' => 0,
                'last_sent_at' => null,
                'created_by' => $createdBy,
            ],
